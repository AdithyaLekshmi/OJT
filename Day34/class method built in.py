...
#  hasattr(obj,name) : to check if an attribute exists or not. setattr(obj,name,value) : to set an attribute.
#  If the attribute does not exist, then it would be created. delattr(obj, name) : to delete an attribute.
